...
def histone_qc():
    return {
        "quality_metric_of": ["/files/ENCFF660DGD/"],
        "uuid":
        "be6c1386-eb16-46db-a6fa-57164b5abd11",
        "Ft":
        0.681145282904541,
        "@id":
        "/histone-chipseq-quality-metrics/be6c1386-eb16-46db-a6fa-57164b5abd11/",
        "npeak_overlap":
        94053,
        "step_run":
        "/analysis-step-runs/bbd6e0ed-9081-4874-8f37-3323c6311ec7/",
        "assay_term_name":
        "ChIP-seq",
        "date_created":
        "2018-03-27T23:07:30.718507+00:00",
        "award":
        "/awards/U41HG006992/",
        "lab":
...
def file_query():
    return {
        "@graph": [{
            ...
            "@type": ["File", "Item"],
            "notes":
            '{"dx-createdBy": {"job": "job-FBZp3z80369GYzY2Jz7FX8Qq", "executable": "applet-F9YvJzj0369JPFjp7zFkkvXg", "user": "user-mkajco"}, "qc": {"npeaks_in": 131917, "npeaks_rejected": 38043, "npeaks_out": 93874}, "dx-parentAnalysis": "analysis-FBZp3z80369GYzY2Jz7FX8Qg", "dx-id": "file-FBZy98j0bY1G7j3xFJ0pGJ2F"}',
            "quality_metrics": [{
                "quality_metric_of": ["/files/ENCFF660DGD/"],
                "uuid":
                "be6c1386-eb16-46db-a6fa-57164b5abd11",
            ...
            "step_run": {
                ...
                "4",
                "@id":
                "/analysis-step-runs/8936804d-d3b8-4207-a40b-c207bed96ae4/",
                "dx_applet_details": [{
                    'dx_job_id': 'dnanexus:job-123'
                }],
                "date_created":
                "2018-03-15T03:29:17.649046+00:00",
                "status":
                "released",
                "@type": [],
                "analysis_step_version":
                "/analysis-step-versions/histone-overlap-peaks-step-v-1-1/",
                "submitted_by":
                "/users/85978cd9-131e-48e2-a389-f752ab05b0a6/",
                "uuid":
                "8936804d-d3b8-4207-a40b-c207bed96ae4",
                "aliases": ["dnanexus:job-FBZp3z80369GYzY2Jz7FX8Qq"]
            }
        }, {
            "@id":
            "/files/ENCFF111DMJ/",
            "@type": ["File", "Item"],
            "notes":
            '{"dx-createdBy": {"job": "job-FBB6BKQ03699JBZqGQFVb3JZ", "executable": "applet-F9YvJzj0369JPFjp7zFkkvXg", "user": "user-keenangraham"}, "qc": {"npeaks_in": 185535, "npeaks_rejected": 36732, "npeaks_out": 148803}, "dx-parentAnalysis": "analysis-FBB6BKQ03699JBZqGQFVb3JQ", "dx-id": "file-FBB8GK001838fKvY2qK8K5q6"}',
            "quality_metrics": [],
            "assembly":
            "GRCh38",
            "status":
            ...
            "step_run": {
                ...
                "4",
                "@id":
                "/analysis-step-runs/8a136540-234d-4a87-b481-8c238bd559a5/",
                "dx_applet_details": [{
                    'dx_job_id': 'dnanexus:job-321'
                }],
                "aliases": [],
                "analysis_step_version":
                "/analysis-step-versions/histone-unreplicated-partition-concordance-step-v-1-0/",
                "status":
                "released",
                "@type": [],
                "date_created":
                "2018-03-01T20:03:52.764975+00:00",
                "uuid":
                "8a136540-234d-4a87-b481-8c238bd559a5",
                "submitted_by":
                "/users/7e95dcd6-9c35-4082-9c53-09d14c5752be/"
            }
        }]
    }
...
@pytest.mark.parametrize(
    'key, value', [('F1', None), ('F2', None), ('Fp', None),
                   ('Ft', 0.681145282904541), ('npeak_overlap',
                                               94053), ('nreads', 30399406),
                   ('nreads_in_peaks', 20706412), ('Ft', 0.681145282904541)])
...
def test_make_url(base_url):
    ...
    assert make_url(base_url, HISTONE_PEAK_FILES_QUERY, [
        EXPERIMENT_FIELDS_QUERY, LIMIT_ALL_JSON
    ]) == (base_url + HISTONE_PEAK_FILES_QUERY + EXPERIMENT_FIELDS_QUERY +
           LIMIT_ALL_JSON)
