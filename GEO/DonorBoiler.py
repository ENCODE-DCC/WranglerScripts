...
with open("/Users/idan/Documents/GEO/3150_Ticket/Example1/ENCDO956IXV.json", encoding='utf-8') as data_file:
...
for entry in data.keys():
    if entry in function_dispatch: # dealing with complex entries
        ...
        if (entry in biosample_interesting_values) or (entry in donor_interesting_values): #dealing with simple entries
